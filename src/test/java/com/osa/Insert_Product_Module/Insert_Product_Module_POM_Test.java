...
public class Insert_Product_Module_POM_Test {
...
//		driver.findElement(By.xpath("//button[@name='submit']")).click();
		...
		ad.LoginasAdmin(ADUSERNAME, ADPASSWORD);
		...
		ah.getInsert_Product_link().click();
...
//	    WebElement categoryDropdown = driver.findElement(By.xpath("//select[@name='category']"));
		...
		WebElement categoryDropdown = i.getCreateCategoryDD();
...
//		WebElement subcategoryDropdown = driver.findElement(By.xpath("//select[@name='subcategory']"));
		WebElement subcategoryDropdown = i.getSub_CategoryDD();
...
//		WebElement avaliability = driver.findElement(By.xpath("//select[@name='productAvailability']"));
		WebElement avaliability =i.getProductAvailabilityDD();
