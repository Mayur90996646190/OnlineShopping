...
public class TextCaptcha {
	public static void main(String[] args) throws Throwable {
		...
		String path ="C:\\Users\\asus\\eclipse-workspace\\com.onlineshopping\\Screenshot\\captcha.png";
		...
		driver.findElement(By.name("captcha")).sendKeys(actualtext);
		driver.findElement(By.xpath("//input[@placeholder='User Name']")).sendKeys("MAYUR9099");
		driver.findElement(By.xpath("//input[@type='password']")).sendKeys("MAYUR12345");
